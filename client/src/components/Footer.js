                ...
                <div className="footer-inner">
                    <div className="footer-brand">
                        ...
                        <p className="footer-desc">
                            {about.bio?.slice(0, 120) || 'Full Stack Developer building modern web applications.'}
                        </p>
                        <div className="footer-socials">
                            {about.github && (
                                <a href={about.github} target="_blank" rel="noreferrer" className="social-icon">
                            ...
                            {about.linkedin && (
                                <a href={about.linkedin} target="_blank" rel="noreferrer" className="social-icon">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
