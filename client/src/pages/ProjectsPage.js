                    ...
                    <div className="projects-grid">
                        ...
                        {projects.map(p => (
                            <div
                                ...
                                style={{ border: '2px solid var(--gold)', transition: 'border-color 0.3s ease, box-shadow 0.3s ease' }}
                                onMouseEnter={e => { e.currentTarget.style.borderColor = '#ffffff'; e.currentTarget.style.boxShadow = '0 8px 32px rgba(255,255,255,0.1)'; }}
                                onMouseLeave={e => { e.currentTarget.style.borderColor = 'var(--gold)'; e.currentTarget.style.boxShadow = 'none'; }}
                            >
                                {p.image
                                    ? <img src={p.image} alt={p.title} className="project-img" />
                                    : <div className="project-img-placeholder">🖼️</div>}
